...
DEFAULT_CONFIG = {
    ...
    "ytdlp_cookie_auto_sync_enabled": False,
    "ytdlp_cookie_auto_sync_browser": "chrome",
    "ytdlp_cookie_auto_sync_interval_hours": 24,
    "ytdlp_cookie_auto_sync_on_sign_in": False,
    "ytdlp_cookie_last_synced_at": "",
    "ytdlp_cookie_last_sync_status": "idle",
    "ytdlp_cookie_last_sync_error": "",
